...
async function getVal() {
  ...
  actualdata.splice(0, actualdata.length);
  ...
  setend = formatDate(y);
  setstart1 = formatDatePrev(x);
  setend1 = formatDatePrev(y);
  console.log(s1,s2,s3,s4,s5);
  console.log(setstart, y, selectcountry);
...
$("#pano").show();
  ...
  //   startdate.replace(/\-/g, '/');
  //   startdate = formatDatePrev(startdate);
  //   enddate = actualdata[j]["EndDate"];
  //   enddate.replace(/\-/g, '/');
  //   enddate = formatDatePrev(enddate);
  ...
  if (actualdata.length == 0 && requireddata2.length == 0 && requiredweblink.length == 0) {
    $("#panelbefore").show();
    $("#opticaldata").hide();
    $("#sardata").hide();
    $("#weblink").hide();
  ...
  for(let i=0;i<allopticaldata.length;i++){
    usershowtable1(i)
...
function flyforsar(i) {
  ...
  map.flyTo([actualdata[i]["flooddata"][0]["Latitude"], actualdata[i]["flooddata"][0]["Longitude"]], 8, {
    duration: 3
  })
  var a = parseFloat(actualdata[i]["flooddata"][0]["Latitude"]);
  var b = parseFloat(actualdata[i]["flooddata"][0]["Longitude"]);
...
function flyforalos(i) {
  ...
  map.flyTo([actualdata[i]["Latitude"] ,actualdata[i]["Longitude"] ], 8, {
    duration: 3
  })
  var a = parseFloat(actualdata[i]["Latitude"] );
  var b = parseFloat(actualdata[i]["Longitude"] );
...
// document.getElementById('sidebar').style.width=700 
// document.querySelector('sidebar').style.width=700+"px"
// document.querySelector('sidebar').style.width=700+"px"
  ...
  if ((allopticaldata[i]["SatelliteName"] === s3)) {
    ...
    for (var j = 0; j < allopticaldata[i]["flooddata"].length; j++) {
    const formatIngestionDate=new Date(allopticaldata[i]["flooddata"][j]["ingestiondate"]).toLocaleDateString()
    const formatBeginDate=new Date(allopticaldata[i]["flooddata"][j]["beginposition"]).toLocaleDateString()
    const formatEndDate=new Date (allopticaldata[i]["flooddata"][j]["endposition"]).toLocaleDateString()
      console.log(allopticaldata[i]["flooddata"][j]); 
      table_data += "<div class='planet_head_row' id='planet_head_row' ><div class='planet_head_cell' ><input type='checkbox' class='custom-control-input' value=false  onclick='rowclickoptical(" + i + "," + j + ");'   id='opticalcheck" + i + "" + j + "'></div><div class='planet_head_cell'>" + allopticaldata[i]["flooddata"][j]["title"] + "</div><div class='planet_head_cell'>" + allopticaldata[i]["flooddata"][j]["summary"] + "</div><div class='planet_head_cell'>" + formatIngestionDate + "</div><div class='planet_head_cell'>" + formatBeginDate+ "</div><div class='planet_head_cell'>" + formatEndDate + "</div><div class='planet_head_cell'>" + allopticaldata[i]["flooddata"][j]["cloudcoverpercentage"] + "</div><div  class='planet_head_cell'><i class='fa fa-plus-circle' onclick='detailsoptical(" + i + "," + j + ");' style='font-size:20px;color:black'></i> </div></div><div class='details_planet'  style='display: none;' id='details_planet" + i + "" + j + "'></div>";
...
console.log(actualdata);
  if ((actualdata[i]["SatelliteName"] === s2)) {
    flyforsar(i);
    rowallflooddata2 = actualdata[i]["flooddata"];
    ...
    for (var j = 0; j < actualdata[i]["flooddata"].length; j++) {
      table_data += "<div class='planet_head_row' id='planet_head_row' ><div class='planet_head_cell' ><input type='checkbox' class='custom-control-input' value=false onclick='rowclicksar(" + i + "," + j + ");' id='sarcheck" + i + "" + j + "'></div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["producttype"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["orbitnumber"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["sensoroperationalmode"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["orbitdirection"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["summary"] + "</div><div  class='planet_head_cell'><i class='fa fa-plus-circle' onclick='detailssar(" + i + "," + j + ");' style='font-size:20px;color:black'></i> </div></div><div class='details_planet' style='display: none;' id='details_sar" + i + "" + j + "'></div>";
  ...
  if ((actualdata[i]["SatelliteName"] === s5)) {
    flyforalos(i);
    rowallflooddata2 = actualdata[i]["flooddata"];
    ...
    for (var j = 0; j < actualdata[i]["flooddata"].length; j++) {
      table_data += "<div class='planet_head_row' id='planet_head_row' ><div class='planet_head_cell' ><input type='checkbox' class='custom-control-input' value=false onclick='rowclickalos(" + i + "," + j + ");' id='aloscheck" + i + "" + j + "'></div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["Sensor Name"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["Total Orbit No"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["Operation Mode"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["Orbit Direction"] + "</div><div class='planet_head_cell'>" + actualdata[i]["flooddata"][j]["Scene ID"] + "</div><div  class='planet_head_cell'><i class='fa fa-plus-circle' onclick='detailssar(" + i + "," + j + ");' style='font-size:20px;color:black'></i> </div></div><div class='details_planet' style='display: none;' id='details_sar" + i + "" + j + "'></div>";
...
function detailssar(i, j) {
  ...
  if ((actualdata[i]["SatelliteName"] === s2)) {
    ...
    var table_data = "<div  class='planet_head_cell'><b>Central lat:</b>" + parseFloat(actualdata[i]["flooddata"][j]["Latitude"]) + "<br><br><b>Central long:</b>" + parseFloat(actualdata[i]["flooddata"][j]["Longitude"]) + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Footprint:</b>" + actualdata[i]["flooddata"][j]["footprint"] + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Link:</b>" + actualdata[i]["flooddata"][j]["link"] + "</div>";
    table_data += "<div  class='planet_head_cell'><b>UUID:</b>" + actualdata[i]["flooddata"][j]["uuid"] + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Relativeorbitnumber:</b>" + parseFloat(actualdata[i]["flooddata"][j]["relativeorbitnumber"]) + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Filename:</b>" + actualdata[i]["flooddata"][j]["filename"] + "</div>";
    table_data += "<div  class='planet_head_cell'></div>";
  ...
  if ((actualdata[i]["SatelliteName"] === s5)) {
    ...
    var table_data = "<div  class='planet_head_cell'><b>Central lat:</b>" + parseFloat(actualdata[i]["Latitude"] ) + "<br><br><b>Central long:</b>" + parseFloat(actualdata[i]["Longitude"] ) + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Footprint:</b>" + actualdata[i]["flooddata"][j]["footprint"] + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Orbit Data Type:</b>" + actualdata[i]["flooddata"][j]["Orbit Data Type"] + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Start Date:</b>" + actualdata[i]["flooddata"][j]["Observation Start Date"] + "</div>";
    table_data += "<div  class='planet_head_cell'><b>End Date:</b>" + parseFloat(actualdata[i]["flooddata"][j]["Observation End Date"]) + "</div>";
    table_data += "<div  class='planet_head_cell'><b>Beam No:</b>" + actualdata[i]["flooddata"][j]["Beam No"] + "</div>";
    table_data += "<div  class='planet_head_cell'></div>";
